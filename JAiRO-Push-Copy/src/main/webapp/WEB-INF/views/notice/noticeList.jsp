...
<link rel="stylesheet" type="text/css" href="/push/resources/css/noticeList.css">
<script type="text/javascript" src="/push/resources/js/jquery-3.3.1.min.js"></script>
<script>
	$(document).ready(function(){
		$("#notice_regi").on("click",function(){
			location.href="/push/noticeRegi"
		});
	});
	function fn_paging(curPage){
		location.href="/push/noticeList?curPage="+curPage;
	}
				...
				<div class="divTableBody">
					<div class="divTableRow">
						...
						<div class="divTableCell">
							<a href="/push/noticeDetail/${v.notice_id}">${v.notice_title}</a>
						</div>
